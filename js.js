...
//the function called when Calculate button is clicked.
{
    ...
    document.querySelector('#btn').onclick = calculateTip;
}

function calculateTip() {
/* values of ID : amount, person and service to
variables for further calculations.*/
let amount = document.querySelector('#number-1').value;
let persons = document.querySelector('#number-2').value;
let service = document.querySelector('#number-3').value;
